        ...
        while 1:
            ...
            if flag == 0:
                ...
                if self.List[0] - shangyici_price > 20 and shangyici_price != 0:
                    ...
                    t1.start()
                # 市价开空
                elif self.List[0] - shangyici_price < -10 and shangyici_price != 0 and flag == 0:
                    flag = 1
                    kongcang = 1
                    # hc开空
            ...
            # 开仓后
                ...
                if duocang == 1:
                    if self.List[0] - open_price < 0:
                        ...
                        duocang = 0
                        # hc平多
                        zoo_create_reptile.close_buy()
                        # hc开空
                        zoo_create_reptile.open_sell()
                        temp = {}
                        temp['open'] = "行情反转平多单"
                        temp['guadan'] = "挂多单"
                        temp['最新价'] = self.List[0]
                ...
                if kongcang == 1:
                    if self.List[0] - open_price > 0:
                        ...
                        temp['平仓/挂单时间'] = time.strftime('%Y-%m-%d %H:%M:%S')
                        # hc平空
                        zoo_create_reptile.close_sell()
                        # hc开多
                        zoo_create_reptile.open_buy()
