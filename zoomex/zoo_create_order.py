...
def main():
    ...
    temp = 'FwsujmWdGEet7S4ZC3FB5yIp7hqIrTGvxLco'
    secret = (temp).encode('utf-8')
    print(secret)
    # create_order(apiKey, secret,'UNIUSDT','Buy','Limit','1','10')
    create_order(apiKey, secret,'BTCUSDT-Perp','Sell','Market','0.001','0', '1') #for market order, we are just passing the price as 0
